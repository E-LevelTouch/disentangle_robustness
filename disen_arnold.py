...
if __name__ == '__main__':
    ...
    # data_loader
    parser.add_argument('--root', default='/mnt/cephfs_new_wj/vc/yufeng/disen_rob/data', type=str)
    parser.add_argument('--robust_path', default='/mnt/cephfs_new_wj/vc/yufeng/disen_rob/data/robust_features_train.pkl', type=str)
    ...
    parser.add_argument('--model_path', type=str, default='/mnt/cephfs_new_wj/vc/yufeng/disen_rob/rst_adv/checkpoint-epoch200.pt')
    # optimizer
    ...
    # log
    parser.add_argument('--out_root', default='/mnt/cephfs_new_wj/vc/yufeng/disen_rob/output', type=str)
